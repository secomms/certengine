...
| Protected | Method | Path           | Parameters                | Data returned        | Description                                         |
|-----------|--------|----------------|---------------------------|----------------------|-----------------------------------------------------|
...
| Protected | Method | Path                   | Parameters                                                                                                                                                                                | Data returned                                                                                                                                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|-----------|--------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|           | POST   | `/api/requestCert`     | `body:{owner:OWNER, user:USER_REQUESTING, data:[{id:dataID, toBeCertified:[{field1: value1}, ...]}, ...], hashAlgo:ALGO}`                                                                 | `{ticket: TICKET}`                                                                                                                                 | Takes new data (list of JSON) to be certified. If defined, the `hashAlgo` is used to hash submitted data. Returns the ticket of the waiting queue. Such information must be stored by the requester in order to request and download certification. If `hashAlgo` is not given, `SHA256` will be used. **Important**: multiple data inside the same certification procedure (multiple certification requests) must use the same **hash algorithm**.                           |
...
|           | POST   | `/api/verify`          | `body:{proof: PROOF, transactionHash: TXHASH, data: DATA, blockchainURL: URL, hashAlgo:ALGO}`                                                                                             | `{valid: BOOL}`                                                                                                                                    | Obtain the integrity test of a data by giving the data itself and blockchain information.                                                                                                                                                                                                                                                                                                                                                                                     |
